...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2024 at 12:20 PM
...
('H001', 'Dell', 'USA', '123456789'),
('H002', 'HP', 'USA', '987654321'),
('H003', 'Asus', 'Taiwan', '543216789'),
('H004', 'Acer', 'Taiwan', '987654123'),
('H005', 'Apple', 'USA', '123987654'),
...
(1001, 'NV001', 'KH001', '2024-10-01 00:00:00', 30000000, 3000000, 27000000, 0),
(1002, 'NV002', 'KH002', '2024-10-02 00:00:00', 28000000, 4200000, 23800000, 0),
(1003, 'NV003', 'KH003', '2024-10-03 00:00:00', 26000000, 1300000, 24700000, 0),
(1004, 'NV004', 'KH004', '2024-10-04 00:00:00', 22000000, 4400000, 17600000, 0),
(1005, 'NV005', 'KH005', '2024-10-05 00:00:00', 33000000, 2310000, 30690000, 0),
(1006, 'NV006', 'KH006', '2024-10-06 00:00:00', 31000000, 3100000, 27900000, 0),
(1007, 'NV007', 'KH007', '2024-10-07 00:00:00', 35000000, 1750000, 33250000, 0),
(1008, 'NV008', 'KH008', '2024-10-08 00:00:00', 29000000, 8700000, 20300000, 0),
(1009, 'NV009', 'KH009', '2024-10-09 00:00:00', 24000000, 7200000, 16800000, 0),
(1010, 'NV010', 'KH010', '2024-10-10 00:00:00', 38000000, 7600000, 30400000, 0);
...
INSERT INTO `loailaptop` (`IDLaptop`, `TenSP`, `GiaBan`, `Hang`, `CPU`, `RAM`, `GPU`, `HinhAnh`, `KichThuoc`, `KhuyenMai`) VALUES
('L001', 'Dell XPS 13', 30000000, 'H001', 'Intel i7', 16, 'Intel Iris', 'xps13.jpg', '13 inch', 'KM001'),
('L002', 'HP Spectre x360', 28000000, 'H002', 'Intel i5', 8, 'Intel Iris', 'spectrex360.jpg', '13.3 inch', 'KM002'),
('L003', 'Asus ZenBook', 26000000, 'H003', 'Intel i7', 16, 'NVIDIA MX250', 'zenbook.jpg', '14 inch', 'KM003'),
('L004', 'Acer Swift 3', 22000000, 'H004', 'Intel i5', 8, 'Intel UHD', 'swift3.jpg', '14 inch', 'KM004'),
('L005', 'Apple MacBook Air', 33000000, 'H005', 'Apple M1', 16, 'Apple GPU', 'macbookair.jpg', '13.3 inch', 'KM005'),
('L006', 'Lenovo ThinkPad X1', 31000000, 'H006', 'Intel i7', 16, 'Intel Iris', 'thinkpadx1.jpg', '14 inch', 'KM006'),
('L007', 'MSI Prestige 14', 35000000, 'H007', 'Intel i7', 32, 'NVIDIA GTX 1650', 'prestige14.jpg', '14 inch', 'KM007'),
('L008', 'Samsung Galaxy Book', 29000000, 'H008', 'Intel i5', 16, 'Intel Iris', 'galaxybook.jpg', '15.6 inch', 'KM008'),
('L009', 'Toshiba Portege', 24000000, 'H009', 'Intel i5', 8, 'Intel UHD', 'portege.jpg', '13.3 inch', 'KM009'),
('L010', 'Sony Vaio SX14', 38000000, 'H010', 'Intel i7', 16, 'Intel Iris', 'vaio.jpg', '14 inch', 'KM010');
...
CREATE TABLE `phieunhap` (
  ...
  `TienTra` bigint(20) NOT NULL,
  `TienThoi` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `phieunhap` (`ID_PhieuNhap`, `MaNV`, `MaNcc`, `NgayNhap`, `TongTien`, `TienTra`, `TienThoi`) VALUES
(1, 'NV001', 'H001', '2024-01-01 08:00:00', 100000, 50000, 50000),
(2, 'NV002', 'H002', '2024-01-02 09:30:00', 200000, 150000, 50000),
(3, 'NV003', 'H003', '2024-01-03 10:15:00', 300000, 200000, 100000),
(4, 'NV004', 'H004', '2024-01-04 11:45:00', 150000, 100000, 50000),
(5, 'NV005', 'H005', '2024-01-05 13:00:00', 250000, 200000, 50000),
(6, 'NV006', 'H006', '2024-01-06 14:30:00', 400000, 300000, 100000),
(7, 'NV007', 'H007', '2024-01-07 15:15:00', 500000, 400000, 100000),
(8, 'NV008', 'H008', '2024-01-08 16:00:00', 350000, 250000, 100000),
(9, 'NV009', 'H009', '2024-01-09 17:30:00', 450000, 300000, 150000),
(10, 'NV010', 'H010', '2024-01-10 18:45:00', 600000, 500000, 100000);
...
--
ALTER TABLE `baohanh`
  ADD CONSTRAINT `baohanh_ibfk_1` FOREIGN KEY (`IMEI`) REFERENCES `laptop` (`IMEI`);
...
--
ALTER TABLE `laptop`
  ADD CONSTRAINT `laptop_ibfk_1` FOREIGN KEY (`LoaiLaptop`) REFERENCES `loailaptop` (`IDLaptop`);
