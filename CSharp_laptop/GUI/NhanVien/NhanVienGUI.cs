...
namespace CSharp_laptop.GUI
{
    public partial class NhanVienGUI : Form
    {
        ...
        {
            if (e.ColumnIndex == dataGridView1.Columns["Column7"].Index && e.RowIndex >= 0 && !IsbtnEditListNameExist(e.RowIndex.ToString()))
            {
            ...
            if (e.ColumnIndex == dataGridView1.Columns["Column8"].Index && e.RowIndex >= 0 && !IsbtnDelListNameExist(e.RowIndex.ToString()))
            {
                // Tạo nút VBButton cho mỗi hàng
                VBButton btn = new VBButton();
                btn.Size = new Size(e.CellBounds.Width, e.CellBounds.Height);
